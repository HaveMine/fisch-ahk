...
Gui, Add, Checkbox, x170 y120 vAutoLookDownCamera, Enable
...
Gui, Add, ComboBox, x190 y40 w100 vShakeMode, Click
...
SaveSettings:
	...
	; AutoEnableCameraMode is deprecated/disabled: do not save
...
LoadSettings:
	...
	; Keep checkbox disabled and unchecked
	GuiControl,, AutoEnableCameraMode, 0
...
tooltip, Fisch Macro V2.0 - Config: %FileNameNoExt%, %TooltipX%, %Tooltip2%, 2
...
tooltip, Press "M" to Reload, %TooltipX%, %Tooltip6%, 6

; (tooltip toggle bagian bawah tetap sama seperti versi kamu)
return
...
tooltip, Press "M" to Reload, %TooltipX%, %Tooltip5%, 5
...
if (AutoEnableCameraMode == true)
	...
	if !ErrorLevel
		{
		sleep 50
		; ; NavigationKey usage removed; keeping simple key presses only
		; send {2}
